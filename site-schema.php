                                 ...
                                 <div itemprop="itemReviewed" itemscope itemtype="https://schema.org/LocalBusiness">  
                                    ...
                                    <span class="d-none"> 
                                        ...
                                        <span itemprop="address" itemscope itemtype="http://schema.org/PostalAddress">
                                            <span itemprop="streetAddress"><?php echo $review_street_address.'&nbsp;'.$review_suite_number; ?> </span> 
                                            <span itemprop="addressLocality"><?php echo $review_city_county ?></span> 
                                            <span itemprop="addressRegion"> <?php echo $review_state; ?></span> 
